...
namespace wap_Project.Forms
{
    ...
    public partial class SignupForm : Form
    {
        ...
        public SignupForm(Client _c, List<Client> _client_list) : this()
        {
            _clients = _client_list;
            _clients.Remove(_c);

            lbSignupTitle.Text = "EDIT CLIENT ACCOUNT";
            btnSignup.Text = "Confirm";

            tbEmail.Text = _c.email;
            tbFirstname.Text = _c.first_name;
            tbLastname.Text = _c.last_name;
            tbPhone.Text = "0" + _c.phone_number.ToString();
            tbPassword.Text = _c.password;
            tbPasswordVer.Text = _c.password;
            tbSecurityQuestion.Text = _c.security_question.question_answer;
            comboBoxSecQ.SelectedIndex = _c.security_question.questionId;
            comboBoxPronouns.SelectedIndex = _c.pronoun;
            comboBoxAge.SelectedIndex = _c.age - 18;
            tbUsername.Text = _c.username;
        }
        ...
        private void antiSqlInjection(object sender, KeyPressEventArgs e)
        {
            ...
            if (notValid.Contains(e.KeyChar))
            {
                // Consume this invalid key
                e.Handled = true;
                lbInvalidPassword.Text = "Invalid character";
            }
            else
            {
                lbInvalidPassword.Text = "";
